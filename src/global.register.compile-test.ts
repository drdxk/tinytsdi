 ...
 *
 * This file contains type assignments that verify TypeScript compilation behavior for the global
 * register function. It should be included in typecheck but not in runtime builds.
 *
